...
function disable_default_dashboard_widgets() {
	...
	https://github.com/eddiemachado/launch/issues
	*/
}
...
function launch_rss_dashboard_widget() {
	...
	<h4 style="margin-bottom: 0;">
		<a href="<?php echo $item->get_permalink(); ?>" title="<?php echo mysql2date( __( 'j F Y @ g:i a', 'launchtheme' ), $item->get_date( 'Y-m-d H:i:s' ) ); ?>" target="_blank">
...
function launch_custom_dashboard_widgets() {
	wp_add_dashboard_widget( 'launch_rss_dashboard_widget', __( 'Recently on Themble (Customize on admin.php)', 'launchtheme' ), 'launch_rss_dashboard_widget' );
	/*
...
function launch_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://yoursite.com" target="_blank">Your Site Name</a></span>. Built using <a href="http://themble.com/launch" target="_blank">launch</a>.', 'launchtheme' );
}
